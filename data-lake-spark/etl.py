...
def process_song_data(spark, input_data, output_data):
    ...
    songs_table = ["title", "artist", "year", "duration"]
...
def process_log_data(spark, input_data, output_data):
    ...
    artists_table = df.selectExpr(users_fields).dropDuplicates()
    ...
    df = df.withColumn("timestamp", get_timestamp(log_df.ts))
    ...
    og_df = df.withColumn("hour", hour("start_time")) \
